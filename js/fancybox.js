(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		getViewport: function () {
			...
			if (locked) {
				...
				// See /web/20141222131551/http://bugs.jquery.com/ticket/6724
	...
	F.transitions = {
		...
		changeIn: function () {
			...
			// Workaround for /web/20141222131551/http://bugs.jquery.com/ticket/12273
			if (effect === 'none') {
				F._afterZoomIn();
	...
	D.ready(function() {
		if ( $.scrollbarWidth === undefined ) {
			// /web/20141222131551/http://benalman.com/projects/jquery-misc-plugins/#scrollbarwidth
